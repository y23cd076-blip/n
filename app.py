...
def build_pdf_vectorstore_from_text(pdf_text: str) -> FAISS:
...
def ensure_pdf_index_for_chat(chat_id: str) -> Optional[FAISS]:
...
def ingest_pdf_for_chat(chat_id: str, pdf_file) -> Optional[FAISS]:
