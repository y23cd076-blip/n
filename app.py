...
if not GOOGLE_API_KEY:
    st.error("GOOGLE_API_KEY environment variable is not set. Please configure it in your deployment.")
    st.stop()

if not SUPABASE_URL or not SUPABASE_ANON_KEY:
    st.error("Supabase configuration is missing. Please set SUPABASE_URL and SUPABASE_ANON_KEY.")
    st.stop()
